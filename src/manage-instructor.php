...
<script>
    ...
    function loadInstructorCourses(classId, instructorId) {
        if (classId) {
            // AJAX call to fetch courses for a given class
            fetch('get_courses.php?instructor_class_id=' + classId + '&instructor_id=' +
                    instructorId)
                .then(response => response.json())
                .then(data => {
    ...
    function loadInstructorStudentsByClass(classId, instructorId) {
        if (classId) {
            // AJAX call to fetch courses for a given class
            fetch('get_courses.php?instructor_student_class_id=' + classId + '&instructor_id=' +
                    instructorId)
                .then(response => response.json())
                .then(data => {
    ...
    function loadInstructorStudentsByClassByCourse(courseId, instructorId) {
        if (courseId) {
            ...
            fetch('get_courses.php?instructor_student_class_course_id=' + courseId + '&instructor_student_class_class_id=' +
